public class storyData {
    public static String getAkariDay1Backgroud(){
        return "image\\Place\\Naohiro.jpg";
    };
    ...
    public static String[] getAkariDay1Choice(){
        return new String[] {"รับทราบครับกัปตัน! แต่อย่ามาร้องไห้โยเยตอนเห็นฉันยกของหนักกว่าเธอก็แล้วกัน", "โหย ฟังดูเหนื่อยชะมัด แอบไปงีบที่ห้องสมุดไม่ได้เหรอ?"};
    };
...
//==============================================================================================================================================================================
    public static String getAkariDay2Backgroud(){
        return "image\\Place\\_convenience_store_2.jpg";
    };
    ...
    public static DialogueLine[] getAkariDay2story(){
        return new DialogueLine[] {
            ...
            new DialogueLine("พระเอก", "\"แค่บางทีเหรอ? ผมนึกว่าผมเป็นฮีโร่ในสายตาเธอไปแล้วซะอีก\"", "image\\image\\Akari\\22b9ada1-d037-49df-95c0-35e2c5531ded.png"),
     ...
     public static String[] getAkariDay2Choice(){
        return new String[] {"งั้นผมจะยอมเป็นคนแก้เหงาให้เธอไปตลอดเลยดีมั้ย?", "กินเลอะหมดแล้วนะอาคาริ มานี่เดี๋ยวเช็ดให้"};
    };
    ...
    public static DialogueLine[] getAkariDay2ResponseA(){
        return new DialogueLine[] {
                    ...
                    new DialogueLine("อาคาริ", "\"นั่นแหละที่น่ารำคาญ! นายทำเหมือนฉันเป็นเด็กตลอดเลย... วันนี้ฉันกลับเองละกัน เจอกันพรุ่งนี้\"", "image\\Akari\\Gemini_Generated_Image_e7ushxe7ushxe7us - แก้ไขแล้ว.png")
                };
    };
     ...
     public static DialogueLine[] getAkariDay2ResponseB(){
        return new DialogueLine[] {
            ...
            new DialogueLine("อาคาริ", "\"อาคาริ: \"นั่นแหละที่น่ารำคาญ! นายทำเหมือนฉันเป็นเด็กตลอดเลย... วันนี้ฉันกลับเองละกัน เจอกันพรุ่งนี้\"", "image\\Akari\\b90f8c5f-34e4-47bf-ae57-d2e6335b3d61.png")
        };
    };

//==============================================================================================================================================================================    
    public static String getAkariDay3Backgroud(){
        return "image\\Place\\_school_rooftop_2.jpg";
    };
    ...
    public static DialogueLine[] getAkariDay3story(){
     ...
     public static String[] getAkariDay3Choice(){
        return new String[] {"ไม่ต้องสมบูรณ์แบบก็ได้ ขอแค่เป็นอาคาริที่วิ่งอย่างสนุกก็พอแล้ว", "ถ้าเธอล้ม ฉันจะยอมแต่งชุดมาสคอตไปวิ่งเป็นเพื่อนเธอเอง"};
    };
    ...
    public static DialogueLine[] getAkariDay3ResponseA(){
        return new DialogueLine[] {
                    ...
                    new DialogueLine("อาคาริ", "\"อาคาริ: \"อื้ม! ตกลง! ฉันจะวิ่งให้เต็มที่ในแบบของฉันเลยล่ะ!\"", "image\\Akari\\Gemini_Generated_Image_e7ushxe7ushxe7us - แก้ไขแล้ว.png")
                };
    };

     public static DialogueLine[] getAkariDay3ResponseB(){
        return new DialogueLine[] {
                    new DialogueLine("อาคาริ", "\"(หลุดขำแต่ดูเหมือนฝืนยิ้ม) \"นายเนี่ยนะ? ชุดมาสคอต? มันจะช่วยให้ฉันหายเครียดหรือจะทำให้ฉันอายคนทั้งโรงเรียนมากกว่ากันนะ\"", "image\\Akari\\b90f8c5f-34e4-47bf-ae57-d2e6335b3d61.png"),
                    new DialogueLine("พระเอก", "\"อ้าว ผมกะจะสร้างสีสันให้เธอเลยนะเนี่ย\"", "image\\Akari\\b90f8c5f-34e4-47bf-ae57-d2e6335b3d61.png"),
...
//==============================================================================================================================================================================
    ...
    public static String getAkariDay4Backgroud(){
        return "image\\Place\\_school_in_spring_2.jpg";
    };
    ...
    public static DialogueLine[] getAkariDay4story(){
     ...
     public static String[] getAkariDay4Choice(){
        return new String[] {"ถ้างั้นขอจองตำแหน่งถังออกซิเจนนี้ยาวๆ เลยได้มั้ย?", "งั้นวันงานต้องจ่ายค่าออกซิเจนเป็นรอยยิ้มสวยๆ ด้วยนะ"};
    };
...
//==============================================================================================================================================================================
    public static String getAkariDay5Backgroud(){
        return "image\\Place\\_school_ground_1.jpg";
    };
    ...
    public static DialogueLine[] getAkariDay5story(){
     ...
     public static String[] getAkariDay5Choice(){
        return new String[] {"ถอยไปเถอะรุ่นพี่ อาคาริเขาไม่ได้เลือกพี่ และพี่ก็ไม่มีสิทธิ์มาสั่งเธอ!", "เราไปจากตรงนี้กันเถอะอาคาริ อย่าไปแลกกับคนแบบนี้เลย"};
    };
    ...
    public static DialogueLine[] getAkariDay5ResponseA(){
        return new DialogueLine[] {
                    ...
                    new DialogueLine("อาคาริ", "\"ฮึก... ขอบคุณนะ... ฉันกลัวมากเลย แต่พอนายก้าวออกมาปกป้องฉัน ฉันก็รู้สึกว่าฉันไม่กลัวอะไรอีกแล้ว\"", "image\\Akari\\c4a1d014-6e7f-4c79-b295-13a803c1a711.png")
                };
    };
     ...
     public static DialogueLine[] getAkariDay5ResponseB(){
        return new DialogueLine[] {
                    ...
                    new DialogueLine("อาคาริ", "\"พอที! นายเอาแต่พาฉันหนี! เขาดูถูกฉันขนาดนั้นแต่นายกลับไม่กล้าแม้แต่จะพูดอะไรเลยเหรอ? ฉันผิดหวังในตัวนายจริงๆ!\"", "image\\Akari\\b90f8c5f-34e4-47bf-ae57-d2e6335b3d61.png")
        };
    };

//==============================================================================================================================================================================
    public static String getAkariDay6Backgroud(){
    ...
    public static DialogueLine[] getAkariDay6story(){
     ...
     public static String[] getAkariDay6Choice(){
        return new String[] {"ถ้าชนะ ฉันขอรางวัลเป็น 'คนข้างๆ' ตลอดไปได้มั้ย?", "ฉันจะรอเธอตรงนี้ ไม่ว่าจะเกิดอะไรขึ้นก็ตาม"};
    };

    public static DialogueLine[] getAkariDay6ResponseA(){
        return new DialogueLine[] {
                    new DialogueLine("อาคาริ", "\"นั่นมัน... คำขอที่เอาแต่ใจที่สุดเลยนะ แต่ก็นะ... ฉันเตรียมคำตอบรอไว้ตั้งนานแล้วล่ะ\"", "image\\Akari\\Gemini_Generated_Image_e7ushxe7ushxe7us - แก้ไขแล้ว.png"),
