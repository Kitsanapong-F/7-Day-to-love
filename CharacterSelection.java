...
public class CharacterSelection extends JFrame {
    ...
    public CharacterSelection(boolean startFullscreen) {
        ...
        BackgroundPanel bg = new BackgroundPanel("image\\_front_of_classroom_1.jpg");
        ...
        centerGrid.add(createGirlCard("Akari", "image\\22b9ada1-d037-49df-95c0-35e2c5531ded.png", "Your energetic childhood friend."));
        centerGrid.add(createGirlCard("Shiori", "image\\fa52fd12-fbd0-4119-8341-014c0b18c47a.png", "The quiet, mysterious librarian."));
        centerGrid.add(createGirlCard("Reina", "image\\a1fd8ce0-99fb-4881-bbee-4677d1b32676.png", "The proud school heiress."));
        ...
        // เพิ่มโค้ดนี้ลงใน Constructor ของ CharacterSelection (ประมาณบรรทัดที่ 65)
        selectBtn.addActionListener(e -> {
            if (!selectedName.isEmpty()) {
                // ส่งชื่อตัวละครที่เลือก (selectedName) และสถานะ Fullscreen ไปที่หน้าเกม
                new VisualNovelUI(selectedName, isFullscreen); 
                this.dispose(); // ปิดหน้าเลือกตัวละคร
            }
        });
