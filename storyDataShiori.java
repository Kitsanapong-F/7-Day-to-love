public class storyDataShiori {
    ...
    public static String[] getShioriDay1Choice(){
        return new String[] {"ใช่แล้ว บรรยากาศที่นี่ดีนะ เพราะมีเธออยู่ด้วยมันเลยดูสงบดีน่ะ", "แค่มันเงียบดีน่ะ เหมาะกับการแอบงีบหลับที่สุดแล้ว"};
    };
...
//==============================================================================================================================================================================
    ...
    public static DialogueLine[] getShioriDay2story(){
     ...
     public static String[] getShioriDay2Choice(){
        return new String[] {"งั้นช่วยพาฉันเข้าไปในโลกของเธอด้วยคนได้ไหม? ฉันอยากเห็นมันจริงๆ", "โลกในจินตนาการมันก็ดีนะ แต่เธอควรจะออกมามองโลกความจริงบ้าง"};
    };
...
//==============================================================================================================================================================================    
    ...
    public static DialogueLine[] getShioriDay3story(){
     ...
     public static String[] getShioriDay3Choice(){
        return new String[] {"เธอมีพรสวรรค์มากนะ! ช่วยเขียนตอนต่อไปให้ผมอ่านอีกได้ไหม?", "เขียนได้ดีนะ แต่อาจจะเพิ่มฉากตื่นเต้นเข้าไปหน่อยจะดีกว่า"};
    };
...
//==============================================================================================================================================================================
    ...
    public static DialogueLine[] getShioriDay4story(){
     ...
     public static String[] getShioriDay4Choice(){
        return new String[] {"(กุมมือเธอเบาๆ) \"สัญญาได้ไหมว่าเราจะรักษาพื้นที่นี้ไว้ด้วยกันตลอดไป?", "วันนี้พักผ่อนเถอะ เธอทำงานหนักมาทั้งวันแล้วนะ"};
    };
...
//==============================================================================================================================================================================
    ...
    public static DialogueLine[] getShioriDay5story(){
     ...
     public static String[] getShioriDay5Choice(){
        return new String[] {"(ก้าวเข้าไปแย่งสมุดคืนมา) \"คืนสมุดเล่มนั้นให้เธอซะ! และอย่ามาทำตัวต่ำๆ ในห้องสมุดอีก!", "รุ่นพี่ครับ รบกวนช่วยคืนสมุดให้เธอด้วย มันเสียมารยาทนะครับ"};
    };
...
//==============================================================================================================================================================================
    ...
    public static DialogueLine[] getShioriDay6story(){
     ...
     public static String[] getShioriDay6Choice(){
        return new String[] {"ถ้าทุกอย่างจบลง ผมขอยืนอยู่ข้างๆ เธอในฐานะ 'คนสำคัญ' ได้มั้ย?","ผมจะมาที่นี่แน่นอน เพราะผมชอบห้องสมุดนี้"};
    };
    ...
    public static DialogueLine[] getShioriGiftStory(){
        return new DialogueLine[] {
                    new DialogueLine("พระเอก", "รุ่นพี่ชิโอริครับ ผมเจอที่คั่นหนังสือลายนี้ คิดว่ารุ่นพี่น่าจะชอบครับ", ""),
                    new DialogueLine("ชิโอริ", "ให้ฉัน... จริงๆ เหรอคะ? ขอบคุณมากเลยค่ะ...", ""),
                    new DialogueLine("ชิโอริ", "(ลูบของขวัญเบาๆ) \"ปกติไม่ค่อยมีใครสังเกตเห็นสิ่งที่ฉันชอบจริงๆ เลย การที่คุณใส่ใจแบบนี้... ฉันดีใจมากค่ะ", "")
        };
    }
}